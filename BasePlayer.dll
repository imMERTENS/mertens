...
public:
	...
	UINT64 GetName() {
		return safe_read((const uintptr_t)(const uintptr_t)this + 0x650, UINT64);
	}
...
private:
	...
	{
		DWORD64 model = safe_read((const uintptr_t)this + 0x118, DWORD64);// public Model model;_public class BaseEntity : BaseNetworkable, IProvider, ILerpTarget, IPrefabPreProcess // TypeDefIndex: 8714
